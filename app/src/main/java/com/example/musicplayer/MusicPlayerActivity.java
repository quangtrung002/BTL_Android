...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    SeekBar seekBar;
    ImageView pausePlay,nextBtn,previousBtn,musicIcon,hengiongu,repeat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hengiongu = findViewById(R.id.hengiongu);
        ...
        countDownTimer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                hengiongu.setImageResource(R.drawable.baseline_alarm_off_24);
            }
        };
        hengiongu.setOnClickListener(new View.OnClickListener() {
            @Override
